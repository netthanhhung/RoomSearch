...
Inherits="RoomSearch.Web.UI.RecoverPassword" 
Title="RoomSearch - Recover Password" %>


<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RoomSearch - Recover Password</title>
</head>
...
<body style="background-color: White;">
    <form id="Form1" runat="server">
        ...
        <div style="text-align: center;">
            <img id="Img2" src="Images/mimosa.gif" alt="RoomSearch" /></div>
