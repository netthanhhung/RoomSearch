...
namespace RoomSearch.Web.UI
{
    public partial class SearchRoomPage : System.Web.UI.Page
    {
        ...
        protected void OnBtnSearch_Clicked(object sender, EventArgs e)
        {
            ...
            List<Post> searchResults = Business.BusinessMethods.SearchPost((int)PostTypes.Room, roomTypeId, 232, cityId, districtId, null, null, null, priceFrom, priceTo, dateFrom, dateTo, null, null, false);
        ...
        private void GetGridRoomResultDataSource(GridSortCommandEventArgs sortEventArgs)
        {
            ...
            gridRoomResult.VirtualItemCount = Business.BusinessMethods.CountPost((int)PostTypes.Room, roomTypeId, 232, cityId, districtId, null, null, null, 
                priceFrom, priceTo, dateFrom, dateTo, null, null, false);                    
            List<Post> searchResults = Business.BusinessMethods.SearchPostPaging((int)PostTypes.Room, roomTypeId, 232, cityId, districtId, null, null, null,
